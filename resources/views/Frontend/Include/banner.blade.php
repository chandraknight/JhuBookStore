...
<div class="kode-banner">
    <ul class="bxslider">
        <li>
            <img src="{{URL::asset('Frontend\images\banner-1.png')}}" alt="">
        ...
        <li>
            <img src="{{URL::asset('Frontend\images\banner-2.png')}}" alt="">
            <div class="kode-caption">
                <h2>book Reading</h2>
        ...
        <li>
            <img src="{{URL::asset('Frontend\images\banner-3.png')}}" alt="">
            <div class="kode-caption">
                <h2>Book Store</h2>
                <h5>Books Guiders</h5>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolor<br>emque
