...
@section('section')
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            @section ('pane2_panel_body')
                <!-- /.panel -->
                    ...
                    <!-- /.panel -->
                @endsection
                @include('Backend.Admin.widgets..panel', array('header'=>true, 'as'=>'pane2'))
            </div>
            <!-- /.col-lg-8 -->
            <div class="col-lg-4">
                @section ('cchart11_panel_title','Line Chart')
                @section ('cchart11_panel_body')
                    @include('Backend.Admin.widgets..charts.clinechart')
                @endsection
                @include('Backend.Admin.widgets..panel', array('header'=>true, 'as'=>'cchart11'))
                ...
                @section ('pane1_panel_body')
                    ...
                    <!-- /.panel-body -->
                @endsection
                @include('Backend.Admin.widgets..panel', array('header'=>true, 'as'=>'pane1'))
        ...
        <!-- /.panel .chat-panel -->
        @endsection
        @include('Backend.Admin.widgets..panel', array('header'=>true, 'as'=>'pane3'))
    </div>
