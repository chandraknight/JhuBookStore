...
@section('content')
    ...
    @include('Frontend.Include.buy_sale')
    <!--CONTENT START-->
    <div class="kode-content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="kode-service">
                            ...
                            <p>Free gift wrapping on all purchases. Wrapping includes a blue box with your choice with
                                Ribbon.</p>
                    ...
                    <div class="col-md-3">
                        <div class="kode-service">
                            ...
                            <p>We provide you the best selling of the used books. You can sell them to us if you have
                                read them once.</p>
                            <a href="#" class="read-more">Read More</a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="kode-service">
                            ...
                            <p>We provide free shipping over the $1000 purchase from one country to another with extra
                                discount.</p>
                            <a href="#" class="read-more">Read More</a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="kode-service">
                            ...
                            <p>Return and Exchange is possible in 5 days. In case of lost or damage Return & Exchange is
                                not possible.</p>
                            <a href="#" class="read-more">Read More</a>
                        </div>
                    </div>
        ...
        <section class="gray-bg kode-best-sellter-sec">
            <div class="container">
                ...
                <div class="section-content">
                    ...
                    <p>The Book Guide and the Book Library has one of the top sellers books with them. Those books which
                        are sold with in few days and still available in our stock which you can get with us easily.</p>
                </div>
                <!--SECTION CONTENT END-->
                <div class="row">
                    <!--PRODUCT GRID START-->
                    ...
                    <ul class="bxslider2">
                        <li>
                            <div class="client-name">
                                <div class="kode-thumb"><img src="images\testimonials-img5.png" alt=""></div>
                                <h2>Anna Doe</h2>
                                <p class="designation">Marketing Manager</p>
                            </div>
                            <div class="kode-text">
                                <p>“Thank you for all your help and assistance over the years! I would have no
                                    hesitation in recommending you to my friends.”</p>
                            </div>
                        </li>
                        <li>
                            <div class="client-name">
                                <div class="kode-thumb"><img src="images\testimonials-img2.png" alt=""></div>
                                <h2>Julia Burns</h2>
                                <p class="designation">The Writer</p>
                            </div>
                            <div class="kode-text">
                                <p>“Now two or three times a year (especially after Christmas) my family shops on the
                                    Book Library – it’s a tradition!”</p>
                            </div>
                        </li>
                        <li>
                            <div class="client-name">
                                <div class="kode-thumb"><img src="images\testimonials-img3.png" alt=""></div>
                                <h2>Sarah Jefferson</h2>
                                <p class="designation">Librarian Manager</p>
                            </div>
                            <div class="kode-text">
                                <p>“I found what I needed and the prices are super low, and the books arrived in a
                                    timely manner. Keep up the great work!”</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <section class="kode-online-book-store">
            <div class="container">
                ...
                <div class="section-content">
                    <h2>The book guide <span>online</span> book store</h2>
                    <p>We’re breaking new ground in online bookselling. We believe that education and access to books
                        are basic human rights. That's why books sold on BetterWorldBooks.com help fund high-impact
                        literacy projects in the United States and around the world.</p>
                </div>
                <!--SECTION HEADING END-->
                <div class="row">
                    <!--BOOK LISTING START-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="kode-blog-list">
                            <div class="kode-thumb">
                                <a href="#"><img src="images\blog.jpeg" alt=""></a>
                                <div class="blog-date">
                                    <p>15</p>
                                    <span>August</span>
                                </div>
                            ...
                            <div class="kode-text">
                                ...
                                <h2>Book Lovers</h2>
                                <p>The Book Lovers is a research project on the phenomenon of artist's novels avaible
                                    today.</p>
                    ...
                    <div class="col-md-6">
                        <div class="kode-blog-list">
                            <div class="kode-thumb">
                                <a href="#"><img src="images\blog2.jpeg" alt=""></a>
                                <div class="blog-date">
                                    <p>10</p>
                                    <span>August</span>
                                </div>
                            ...
                            <div class="kode-text">
                                ...
                                <p>The Indie View is the most popular book of the all india times written by a famous
                                    author.</p>
                                <a href="#" class="more">SEE MORE</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="kode-blog-list">
                            <div class="kode-thumb">
                                <a href="#"><img src="images\blog3.jpeg" alt=""></a>
                                <div class="blog-date">
                                    <p>20</p>
                                    <span>August</span>
                                </div>
                            ...
                            <div class="kode-text">
                                ...
                                <p>Modern Ebbooks selling is the most advance and popular way of sellings books online
                                    today.</p>
                                <a href="#" class="more">SEE MORE</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="kode-blog-list">
                            <div class="kode-thumb">
                                <a href="#"><img src="images\blog4.jpeg" alt=""></a>
                                <div class="blog-date">
                                    <p>15</p>
                                    <span>August</span>
                                </div>
                            ...
                            <div class="kode-text">
                                ...
                                <p>Now learning is made very easy to learn with joy , E learning is made very easily and
                                    comfortable.</p>
                                <a href="#" class="more">SEE MORE</a>
                            </div>
                        </div>
                ...
                <div class="kode-gift">
                    <ul>
                        <li>
                            ...
                            <p>The great philosopher Blaise Pascal believed that human misfortune was the result of
                                other people’s inability “to sit quietly in one’s room”</p>
                        </li>
                        <li>
                            <h2><a href="#"><i class="fa fa-graduation-cap"></i>Special Occasion</a></h2>
                            <p>Here are many special occasions in the lives of our friends, family and colleagues, and
                                each offers an opportunity to commemorate the day with a unique and personalised
                                book.</p>
                        </li>
                        <li>
                            <h2><a href="#"><i class="fa fa-smile-o"></i>CArds For Kids</a></h2>
                            <p>The thrill of double war. The excitement of shouting "Gin!" Every kid knows at least a
                                handful of card classics, and every grown up kid remembers the fun of playing them.</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section class="kode-package-section">
            <div class="container">
                ...
                <div class="section-content">
                    ...
                    <p>Find your best prices of the books preimum packages that are available with us. You can purchase
                        the prices and get the discount of the purchase of the books.</p>
                </div>
                <!--SECTION CONTENT END-->
                <div class="row">
                    <div class="col-md-4">
